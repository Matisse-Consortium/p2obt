...
def print_fluxes(target_name):
    sdic = qc.query_CDS(target_name,catalogs=['simbad','gaia','wise','mdfc'])
    try:
    ...
    print('%s,%.2f,%.2f,%.2f,%.2f,%.2f'%(target_name,sdic['FLUX_V'],sdic['Gmag'],sdic['Kmag'],Lflux,Nflux))
